...
import (
	...
	core_http_types "github.com/pkpal-uhobp/todo-app/internal/core/transport/http/types"
...
func (r *PatchUserRequest) Validate() error {
	if r.FullName.Set {
		...
		if fullNameLen < 3 || fullNameLen > 100 {
			return fmt.Errorf("full_name: must be between 3 and 100")
		}
	}
	if r.PhoneNumber.Set {
		if r.PhoneNumber.Value != nil {
			...
			if phoneNumberLen < 10 || phoneNumberLen > 15 {
				return fmt.Errorf("phone_number: must be between 10 and 15")
			}
